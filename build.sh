...
if [ $clam_result -gt 0 ]; then
	...
	echo "docker push ackdev/secure_proxy_securitas-wall-base-1:2026-06-23-r1;docker push ackdev/secure_proxy_securitas-wall-base-devtools:2026-06-23-r1;docker push ackdev/secure_proxy_securitas-wall-base-xfce:2026-06-23-r1;docker push ackdev/secure_proxy_securitas-wall:$current_timestamp"
#	echo ""
#	echo "docker push ackdev/secure_proxy_securitas-wall-base-xfce:2026-06-23-r1"
